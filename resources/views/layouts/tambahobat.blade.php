...
<body>
    <h1 class="text-center mb-5 mt-5"> Tambah Data Obat</h1>
    ...
    <div class="container mb-5">
        ...
        <div class="card">
          <div class="card-body">
          <form action="{{url('insertobat')}}" method="GET" enctype="multipart/form-dats">
            @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="pemroduksi" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
