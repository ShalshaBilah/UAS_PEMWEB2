...
<nav class="main-header navbar navbar-expand navbar-dark">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('adminLTE/dist/img/favicon1.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <i class=" nav-icon fas fa-truck-moving"></i>              <p>
                Data Supplier
              </p>
            </a>
          </li>
...
@yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Apotik Nurani</a>.</strong>
    All rights reserved.
